...
<div class="regContainer container"> 
    ...
    <form class="form well restaurant-add-form" role="form" data-toggle="validator"
        ...
        <div class="form-group">
            <div class="row">
                <label class="col-md-3">Restaurant Description:</label> 
                <div class="col-md-8">
                    <textarea class="form-control" type="text" rows="2" id="description" name="description" placeholder="This is an amazing place to dine." ></textarea>
                </div>
            </div>
        </div>
